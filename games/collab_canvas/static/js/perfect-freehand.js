(function (global) {
  'use strict';
  // perfect-freehand v1.2.3 (MIT) — minified CJS bundle wrapped for browser global.
  const exports = {};
...
//# sourceMappingURL=index.js.map
  /** 将 getStroke 轮廓转为 Canvas fill 路径（二次贝塞尔平滑）。 */
  function fillStrokePath(context, outline) {
    ...
    for (let i = 1; i < outline.length; i += 1) {
      ...
      context.quadraticCurveTo(prev[0], prev[1], (prev[0] + curr[0]) / 2, (prev[1] + curr[1]) / 2);
    }
    context.closePath();
    context.fill();
  }
